...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: Sidepane2Widget.routeName,
          path: Sidepane2Widget.routePath,
          builder: (context, params) => Sidepane2Widget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: AivoicepageWidget.routeName,
          path: AivoicepageWidget.routePath,
          builder: (context, params) => AivoicepageWidget(),
        ),
        FFRoute(
