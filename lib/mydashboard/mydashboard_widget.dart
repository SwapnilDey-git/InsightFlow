...
import 'mydashboard_model.dart';
export 'mydashboard_model.dart';

/// Make a dashboard page for all the previos reports sorted by  date and time
/// with interactive UI elements and make it match the app theme with good
/// containaers adn no open edges
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'View and manage all your previous reports',
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
